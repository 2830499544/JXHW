...
namespace JXHighWay.WatchHouse.Net
{
    ...
    public class SocketServer : IDisposable
    {
        ...
        public Dictionary<string, SocketAsyncEventArgs> SAEADict;
        ...
        public SocketServer(IPAddress localIPAddress, int listenPort, int maxClient)
        {
            ...
            SAEADict = new Dictionary<string, SocketAsyncEventArgs>(maxClient);
        }
            ...
            if (e.SocketError == SocketError.Success)
            {
                ...
                if (s.Connected)
                {
                    try
                    {
                        ...
                        SAEADict.Add(s.RemoteEndPoint.ToString(), e);
