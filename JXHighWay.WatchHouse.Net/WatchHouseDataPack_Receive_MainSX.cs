...
namespace JXHighWay.WatchHouse.Net.DataPack
{
    public struct WatchHouseDataPack_Receive_MainSX
    {
        ...
        /// Data[5]
        /// </summary>
        public byte QianChuang { get; set; }
        /// <summary>
        /// 前风幕状态(0:闭 1:开)
        /// Data[6]
        /// </summary>
        ...
        /// Data[7]
        /// </summary>
        public byte QianChuangDeng { get; set; }
        /// <summary>
        /// 新风状态(0:闭 1:开)
        /// Data[8]
        /// </summary>
        ...
        ///Data[29]
        /// </summary>
        public byte QianChuangKongCKQ { get; set; }
        /// <summary>
        ///前工控机输出IO状态
        ///0 无效，1 有效
        ///Bit.0 落栏杆
        ...
        ///Data[30]
        /// </summary>
        public byte QianGongKongJSC { get; set; }
        /// <summary>
        /// 工控机输入IO状态
        /// 0 无效，1 有效
        ///Bit.0
        ...
        ///Data[31]
        /// </summary>
        public byte QianGongKongJSR { get; set; }
        /// <summary>
        /// 灯光亮度(25%->100%)
        /// Data[32]
        /// </summary>
        ...
        /// Data[33]
        /// </summary>
        public byte HouChuang { get; set; }
        /// <summary>
        /// 后风幕
        /// Data[34]
        /// </summary>
        public byte HouFengMu { get; set; }
        /// <summary>
        /// 后窗灯[35]
        /// </summary>
        public byte HouChuangDeng { get; set; }
        /// <summary>
        /// 后窗控传感器状态
        ///Bit.0 1 sensor1 有效
        ///Bit.1 1 sensor2 有效
        ...
        ///Data[36]
        /// </summary>
        public byte HouChuangKongCKQ { get; set; }
        /// <summary>
        ///后工控机输出IO状态
        ///0 无效，1 有效
        ///Bit.0 落栏杆
        ...
        ///Data[37]
        /// </summary>
        public byte HouGongKongJSC { get; set; }
        /// <summary>
        /// 工控机输入IO状态
        /// 0 无效，1 有效
        ///Bit.0
        ...
        ///Data[38]
        /// </summary>
        public byte HouGongKongJSR { get; set; }
        /// <summary>
        /// 新风等级
        /// Data[39]
        /// </summary>
